...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8 mt-6 text-slate-800 dark:text-white">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-b-lg shadow p-4">
            <div>
            ...
            @if ($recall->products_count === 0)
                <p class="text-slate-500 dark:text-slate-300 truncate">
                    ...
                    <a target="_blank" href="{{$recall->mra_public_notice_url}}" class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-slate-300 dark:border-slate-600 leading-5 font-medium rounded-full text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                ...
                <div class="relative rounded-lg border border-slate-300 dark:border-slate-500 bg-white dark:bg-slate-800 dark:hover:bg-slate-700 px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-slate-400 dark:hover:border-slate-700 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                    ...
                    <div class="text-right">
                        <a href="/dispensary/{{$dispensary->license_number}}" class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-slate-300 dark:border-slate-600 leading-5 font-medium rounded-full text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800">View {{$dispensary->license_type}} facility</a>
                    </div>
                </div>
                @endforeach
            </div>
